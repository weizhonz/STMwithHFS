function plot_rej_ratio(Lambda,rej_ratio,scale,data_name,result_path)
...
saveas(h, [result_path figure_name],'png');
saveas(h, [result_path figure_name],'pdf');
saveas(h, [result_path figure_name],'fig');
